...
/*    	System.out.println();
    	...
    	System.out.println("distIdx: "+distIdx+" visited: "+Arrays.toString(visited));*/
        //끝까지 다 갔는지 확인
        if(distIdx >= dist.length){
        	//System.out.println("DFS end (disIdx>=dist.length) "+ distIdx + " > "+dist.length);
        ...
        for(int i=0;i<weak.length;i++){
            ...
            //System.out.println("정방향 src: "+src+" dest: "+dest);
            //정방향
            ...
            if(allIn){
            	System.out.println("answer : distIdx = "+answer+" : "+distIdx);
            ...
            //System.out.println("역방향 src: "+src+" dest: "+dest);
